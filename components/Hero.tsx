...
export default function Hero() {
  return (
    <>
      ...
      <div className="fixed left-6 -translate-y-1/2 z-40 hidden lg:flex flex-col gap-4">
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div
            key={i}
      ...
      {/* Hero Section */}
      <section className="relative w-full min-h-screen pt-32 pb-20 px-6 md:px-10 lg:px-24 flex items-center justify-center">
        <div className="w-full max-w-[1600px] mx-auto flex flex-col lg:flex-row items-center justify-between gap-12">
          {/* Left Content (50%) */}
          <motion.div
            className="w-full lg:w-[50%] flex flex-col z-10"
          ...
          {/* Right Content - Hero Robot World (50%) */}
          <div className="w-full lg:w-[50%] h-[60vh] lg:h-[80vh] relative mt-16 lg:mt-0 flex items-center justify-center">
            {/* Main Robot Image */}
            <motion.div
